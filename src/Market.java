...
public class Market {
    ...
    static int Enemy_HP = 10;               //적 능력치
    static int Enemy_Power = 2;
    static int Enemy_Defense = 10;
    ...
    static ArrayList market_fight(String Cat_name, int Cat_MaxHP ,int Cat_HP, int Cat_Power, int Cat_Defense, int Cat_Agility, int Cat_Critical, int HealthPosion, int PowerPosion, int DefensePosion ,int AgilityPosion, int CriticalPosion, int HeallingPosion) throws IOException {
        ...
        while(true) {
            ...
            Enemy.market_zombie(Enemy_HP, Enemy_Power, Enemy_Defense, Enemy_Agility);    //적 모습 출력
