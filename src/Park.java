...
public class Park {
    ...
    static int Enemy_HP = 5;               //적 능력치
    static int Enemy_Power = 1;
    static int Enemy_Defense = 0;
    static int Enemy_Agility = 5;
    ...
    static ArrayList Park_fight(String Cat_name, int Cat_MaxHP ,int Cat_HP, int Cat_Power, int Cat_Defense, int Cat_Agility, int Cat_Critical, int HealthPosion, int PowerPosion, int DefensePosion ,int AgilityPosion, int CriticalPosion, int HeallingPosion) throws IOException {
        ...
        while(true) {
            ...
            Enemy.Park_zombie(Enemy_HP, Enemy_Power, Enemy_Defense, Enemy_Agility);    //적 모습 출력
