...
public class Army {
    ...
    static int Enemy_HP = 50;               //적 능력치
    static int Enemy_Power = 4;
    static int Enemy_Defense = 2;
    static int Enemy_Agility = 2;
    ...
    static ArrayList army_fight(String Cat_name, int Cat_MaxHP ,int Cat_HP, int Cat_Power, int Cat_Defense, int Cat_Agility, int Cat_Critical, int HealthPosion, int PowerPosion, int DefensePosion ,int AgilityPosion, int CriticalPosion, int HeallingPosion) throws IOException {
        ...
        while(true) {
            ...
            Enemy.Army_zombie(Enemy_HP, Enemy_Power, Enemy_Defense, Enemy_Agility);    //적 모습 출력
